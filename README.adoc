...
* https://materialize.com/[Materialize] fast analytics on constantly changing data. Built on top of differential dataflow
...
* classic neo4j
* https://memgraph.com/[Memgraph] fast graph db? 
...
* networkX
* https://github.com/dsg-uwaterloo/graphsurge[Experimental - GraphSurge] Built on top of differential dataflow
